...
public class PersonneControllerAPI {
     ...
     *
     *
     * public ResponseEntity<Personne> savepersonne (@RequestBody Personne l) {
     * service.insert(l); return new ResponseEntity<>(HttpStatus.CREATED);
     *
     * }
     *
     ...
     *
     *
     * public ResponseEntity<?> delete (@PathVariable ("lastName") String l){
     * service.Suppresion(l); return new ResponseEntity<>(HttpStatus.OK);
     *
     * }
     *
     * @PutMapping ("/update")
     ...
     *
     *
     * public ResponseEntity<Personne> update (@RequestBody Personne l) {
     * service.insert(l); return new ResponseEntity<>(HttpStatus.CREATED); }
     */
